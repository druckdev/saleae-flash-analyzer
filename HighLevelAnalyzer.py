...
#
# NOTE: addr and dummy can be either an integer or a tuple of length 2. In the
#   case of the later, the value will be selected depending on if the 4-Byte
#   Address Mode is activated or not.
...
COMMANDS = {
    ...
    0xAB: {'name': 'Release Power-down / Device ID',        'addr': 0,      'dummy': 3,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    0x90: {'name': 'Read Manufacturer/Device ID',           'addr': 0,      'dummy': 3,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    0x9F: {'name': 'Read JEDEC ID',                         'addr': 0,      'dummy': 0,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    0x4B: {'name': 'Read Unique ID',                        'addr': 0,      'dummy': (4, 5), 'dir': 'read',  'multi': False, 'rtype': 'read'},

    # ── Standard SPI reads ───────────────────────────────────────────────────
    0x03: {'name': 'Read Data',                             'addr': (3, 4), 'dummy': 0,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    ...
    0x52: {'name': '32KB Block Erase',                      'addr': (3, 4), 'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'erase'},
    0xD8: {'name': '64KB Block Erase',                      'addr': (3, 4), 'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'erase'},
    ...
    0x5A: {'name': 'Read SFDP',                             'addr': (3, 4), 'dummy': 1,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    0x44: {'name': 'Erase Security Register',               'addr': (3, 4), 'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'erase'},
    0x42: {'name': 'Program Security Register',             'addr': (3, 4), 'dummy': 0,      'dir': 'write', 'multi': False, 'rtype': 'write'},
    0x48: {'name': 'Read Security Register',                'addr': (3, 4), 'dummy': 1,      'dir': 'read',  'multi': False, 'rtype': 'read'},
    ...
    0x3D: {'name': 'Read Block/Sector Lock',                'addr': (3, 4), 'dummy': 0,      'dir': 'read',  'multi': False, 'rtype': 'status'},
    0x36: {'name': 'Individual Block Lock',                 'addr': (3, 4), 'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'ctrl'},
    0x39: {'name': 'Individual Block Unlock',               'addr': (3, 4), 'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'ctrl'},
    ...
    0xB7: {'name': 'Enter 4-Byte Address Mode',             'addr': 0,      'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'ctrl', '4addr': True},
    0xE9: {'name': 'Exit 4-Byte Address Mode',              'addr': 0,      'dummy': 0,      'dir': None,    'multi': False, 'rtype': 'ctrl', '4addr': False},
...
class Hla(HighLevelAnalyzer):
    ...
    # If there was a 'Enter 4-Byte Address Mode' command before the start of the
    # trace
